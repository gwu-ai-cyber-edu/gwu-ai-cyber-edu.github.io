...
7. Submit your files (at minimum `best_model.ipynb`, the file scored for the bonus competition) through the course submission Google Form your instructor shares.
