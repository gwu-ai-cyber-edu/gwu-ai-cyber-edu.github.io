...
- [ ] Join the class through the **GitHub Classroom assignment**: **[accept the invite here](https://classroom.github.com/classrooms/289898063-gwu-ai-cyber-edu-gh-classroom)**. Accepting creates your team repository from the starter template. The invite is also projected on the final slide of the morning primer.
